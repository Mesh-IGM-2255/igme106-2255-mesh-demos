...
namespace PE_MG_Buttons
{
    ...
    public delegate void OnButtonClickDelegate(); // RULES FOR METHODS TO MATCH
    ...
    public class Button
    {
        ...
        /// </summary>
        public event OnButtonClickDelegate OnButtonClick; // LIST OF METHODS THAT MATCH RULES

        private OnButtonClickDelegate singleMethodRef;
